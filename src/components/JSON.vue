...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 6: Rensdsdder a list containing author names and their birth years. Hint: Make use of the v-for directive to iterate through the array of authors. -->
      ...
      <!-- Activity 7: Render a liist containing authors born after 1850. Hint: Make use of the v-for directive to iterate through the array of authors that you have filtered out. -->
    ...
    {{ bookstores.totalStores }}
     ...
     <ul>
     <li v-for="(count, day) in bookstores.openingHours" :key="day">
     {{ day }} open: {{ count.open }} close: {{ count.close }}
     </li>
     </ul>
